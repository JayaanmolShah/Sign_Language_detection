...
def main():
    ...
    st.sidebar.image('signext_logo.png')
...
def about_us_page():
    ...
    m2.image('raj.jpeg')
    m1.header("")
    m1.markdown("<h4 style='color:#4cd4bc'>Rajnandini Patil</h4>", unsafe_allow_html=True)
    m1.header("")
    m1.write("I am currently pursuing a Bachelor of Engineering degree at AISSMSCOE in Pune. Prior to this, I completed a diploma in Computer Engineering at ICRE Polytechnic. I am actively engaged in Android app development and concurrently studying web development.")
